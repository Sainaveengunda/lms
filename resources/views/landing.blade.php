    ...
    <body class="bg-gray-200 font-sans flex flex-col items-center">
        ...
        <main class="mt-16 w-full flex flex-col items-center">
            <div class="max-w-4xl mx-4">
                <h2 class="pb-1 font-bold text-xl text-indigo-700 border-b boder-indigo-600">How It Works</h2>
                ...
                <h2 class="mt-8 pb-1 font-bold text-xl text-indigo-700 border-b boder-indigo-600">Advantages</h2>
                ...
                <div class="flex flex-col sm:flex-row sm:-mx-2">
                    ...
                    <div class="mt-4 sm:w-1/3">
                        <div class="bg-white h-full p-8 border-b-4 border-pink-500 rounded-lg flex flex-col items-center sm:mx-2 sm:p-3 md:p-8">
                            <div class="bg-gray-200 text-indigo-700 w-16 rounded-full p-2">
                                <svg class="h-12 w-12 fill-current" xmlns="C:\Users\sainaveen.g\Desktop\Desk Files\Health\N.jpg" viewBox="0 0 24 24"><path d="M18.9 19.7l-6.9 2-6.9-2L3.7 3h16.7c-.5 5.6-1 11.1-1.5 16.7zM19.4 4H4.8l1.3 14.9 5.9 1.7 5.9-1.7L19.4 4zM8.1 13.8h2V15l2 .7 2-.7.1-2.2H9.9l-.1-2h4.5l.1-2H7.7l-.1-2h9l-.2 3.9-.4 5.8-3.9 1.3-3.9-1.3-.1-2.7z" fill-rule="evenodd" clip-rule="evenodd"/></svg>
                            </div>
            ...
            <div class="bg-gray-800 py-12 mt-12 w-full flex flex-col items-center border-t-2 norder-black">
                <h2 class="font-bold text-xl text-gray-400">Sign up</h2>
        ...
        <footer class="bg-gray-800 w-full text-center pb-8">
            <p class="text-xs text-gray-600 font-light"></p>
        </footer>
    </body>
</html>