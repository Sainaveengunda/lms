...
<div class="flex mt-6">
<div>
    <h1 class="ml-12  text-red-700 font-bold">Language: {{ $article->course_language}}</h1>
</div>
<div>
    <h1 class="ml-12 text-red-700 font-bold">Difficulty: {{ $article->course_difficulty}}</h1>
</div>
...
<form method="POST" action="/courses/{{$article->id}}/enroll" >

@csrf

<button type="submit" class="mt-4 ml-12 mb-4 px-16 py-4 shadow bg-red-700 rounded hover:bg-blue-800 text-gray-400 text-xl">Enroll</button>
</form>
