...
<div class="flex flex-row">
        ...
        <div x-show="open" x-transition:enter="transition ease-out duration-100" x-transition:enter-start="transform opacity-0 scale-95" x-transition:enter-end="transform opacity-100 scale-100" x-transition:leave="transition ease-in duration-75" x-transition:leave-start="transform opacity-100 scale-100" x-transition:leave-end="transform opacity-0 scale-95" class="absolute right-0 w-full mt-2 origin-top-right rounded-md shadow-lg md:w-48">
          <div class="px-2 py-2 bg-white rounded-md shadow dark-mode:bg-gray-800">
            <a class="block px-4 py-2 mt-2 text-sm font-semibold bg-transparent rounded-lg dark-mode:bg-transparent dark-mode:hover:bg-gray-600 dark-mode:focus:bg-gray-600 dark-mode:focus:text-white dark-mode:hover:text-white dark-mode:text-gray-200 md:mt-0 hover:text-gray-900 focus:text-gray-900 hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline" href="/editprofile">Profile</a>
            <a class="block px-4 py-2 mt-2 text-sm font-semibold bg-transparent rounded-lg dark-mode:bg-transparent dark-mode:hover:bg-gray-600 dark-mode:focus:bg-gray-600 dark-mode:focus:text-white dark-mode:hover:text-white dark-mode:text-gray-200 md:mt-0 hover:text-gray-900 focus:text-gray-900 hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline" href="/mycourses">My Courses</a>
   ...
   @csrf
    <div class="mt-4 mr-16 ml-16 max-w-full border border-gray-700  h-auto rounded items-center overflow-hden shadow-lg">
        ...
        <label class="block mt-8 h-16 ml-12">
             ...
             <input name="profile_name" class="form-input mt-1 h-16 rounded border border-gray-300 text-xl text-gray-700 block w-full" placeholder="">            
        </label>
        <label class="block mt-8 h-16">
             <span class="text-gray-700 h-12 font-serif">Work</span>
             <input name="profile_work" class="form-input mt-1 h-16 rounded border border-gray-300 text-xl text-gray-700 block w-full" placeholder="">            
        </label>
        <label class="block mt-10 h-16 mb-4 mr-12">
             <span class="text-gray-700 h-12 font-serif">Education</span>
             <input name="profile_education" class="form-input mt-1 h-16 rounded border border-gray-300 text-xl text-gray-700 block w-full" placeholder="">            
        </label>
        </div>
        <label class="block mt-10 mr-12 ml-12">
            <span class="text-gray-700 font-serif">Bio</span>
            <textarea name="profile_bio" class="form-textarea h-32 mt-1 border text-gray-700 block w-full"  rows="3" placeholder="Enter your Bio"></textarea>
        </label>
        <div class="flex rows justify-between">
        <label class="block mt-8 h-16 ml-12">
             <span class="text-gray-700 h-12 font-serif">Country</span>
             <input name="profile_country" class="form-input mt-1 h-16 rounded border border-gray-300 text-xl text-gray-700 block w-full" placeholder="">            
        </label>
        <label class="block mt-8 h-16">
             <span class="text-gray-700 h-12 font-serif">Location</span>
             <input name="profile_location" class="form-input mt-1 h-16 rounded border border-gray-300 text-xl text-gray-700 block w-full" placeholder="">            
        </label>
        <label class="block mt-10 h-16 mb-4 mr-12">
             <span class="text-gray-700 h-12 font-serif">Industry</span>
             <input name="profile_industry" class="form-input mt-1 h-16 rounded border border-gray-300 text-xl text-gray-700 block w-full" placeholder="">            
        </label>
        </div>

    <div>
    <button type="submit" class="center m-4 ml-12 bg-indigo-200 border-b-4 border-indigo-800 px-3 py-1">Save</button>
     </div>
</form>
