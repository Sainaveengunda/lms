...
<div class="mt-4">
<form action="/quiz/query" method="POST" enctype="multipart/form-data">
<div class="container">
        <div class="row">
            <div class="col-md-12">
                <div id="quiz-wrapper">
                    ...
                    @foreach($question->answer->follows() as $answer)
                    <h3>
                    <input type="radio" value="{{$question->answer}}" id="answer" name="answer" value="answer">
                    <label for="answer">Male</label><br>
