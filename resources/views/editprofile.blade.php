...
<div class="flex justify-start ">
    ...
    <div class="class">
    <h1 class="text-grey-700 font-bold text-xl  mr-24 ">{{$i->profile_name}}</h1>
    </div>
    <div class="class">
    
    <h1 class="text-grey-700 font-bold text-xl ml-16">{{$i->profile_work}}</h1>
    </div>
...
<h1 class="text-xl font-bold"> Bio</h1>
    <h1 class="text-grey-700  text-sm">{{$i->profile_bio}}</h1>
    <hr class="mt-4 bg-red-400">
    <div class="mt-4 mr-16">
  <a href="{{ route('editt') }}" class="m-4 mt-4 ml-24 mb-4 border-2 text-center border-blue-500 text-red-500 rounded px-3 py-1">Edit</a>
 </div>
@endforeach
